  ...
  return (data?<>
    <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
        <div className='flex justify-between items-center'>
            ...
            <button className='flex items-center gap-2 font-medium py-1 px-3 sm:[y-3 sm:px-6 border border-black shadow-[-7px_7px_0px_#000000]'>
    ...
    <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
        ...
        <h3 className='my-5 text-[18px] font-semibold'>Temporary Text H3</h3>
        <p className='my-3'>Temporary Text P</p>
        <p className='my-3'>Temporary Text P</p>
        <h3 className='my-5 text-[18px] font-semibold'>Temporary Text H3</h3>
        <p className='my-3'>Temporary Text P</p>
        <p className='my-3'>Temporary Text P</p>
